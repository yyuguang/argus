export default {
  ...
  userDemo: {
    ...
    passwordPlaceholder: 'Please enter at least 8 characters',
    passwordRule: 'Password must be at least 8 characters',
    passwordResetPrompt: 'Please enter a new password with at least 8 characters',
    passwordResetSuccess: 'Password reset successfully',
    selectSingleUser: 'Please select exactly one user',
    batchStatusConfirm: 'Are you sure you want to {action} the selected {count} account(s)?',
