...
export const constantRouterMap: AppRouteRecordRaw[] = [
  ...
  {
    path: '/quality',
    redirect: '/code-review/scm-config',
    name: 'QualityLegacyRoot',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
  ...
  {
    path: '/quality/scm-config',
    redirect: '/code-review/scm-config',
    name: 'QualityScmConfigLegacy',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
  ...
  {
    path: '/quality/review-task',
    redirect: '/code-review/review-task',
    name: 'QualityReviewTaskLegacy',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
  ...
  },
  {
    ...
    redirect: '/code-review/knowledge-base',
    name: 'QualityKnowledgeBaseLegacy',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
  ...
  {
    path: '/quality/personal-quality',
    redirect: '/code-review/personal-quality',
    name: 'QualityPersonalQualityLegacy',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
  ...
  {
    path: '/quality/errors',
    redirect: '/error-governance/errors',
    name: 'QualityErrorsLegacy',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
  ...
  },
  {
    ...
    redirect: '/error-governance/error-type-rules',
    name: 'QualityErrorTypeRulesLegacy',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
  ...
  {
    path: '/quality/app-linkage',
    redirect: '/application-governance/app-linkage',
    name: 'QualityAppLinkageLegacy',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
  ...
  },
  {
    ...
    redirect: '/monitor-center/data-monitor',
    name: 'QualityDataMonitorLegacy',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
  ...
  {
    path: '/quality/data-monitor-config',
    redirect: '/monitor-center/data-monitor-config',
    name: 'QualityDataMonitorConfigLegacy',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
  ...
  },
  {
    ...
    redirect: '/monitor-center/data-monitor-config',
    name: 'QualityDataMonitorConfigsLegacy',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
  ...
  {
    path: '/quality/rule-management',
    redirect: '/rule-governance/rule-documents',
    name: 'QualityRuleManagementLegacy',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
  ...
  {
    path: '/rule-governance/rule-management',
    redirect: '/rule-governance/rule-documents',
    name: 'RuleGovernanceManagementLegacy',
    meta: {
      hidden: true,
      canTo: true,
      noTagsView: true
